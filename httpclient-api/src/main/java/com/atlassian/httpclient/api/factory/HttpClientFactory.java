...
public interface HttpClientFactory {
     ...
     */
    @Nonnull
    HttpClient create(@Nonnull HttpClientOptions options);
     ...
     */
    @Nonnull
    <C> HttpClient create(@Nonnull HttpClientOptions options, @Nonnull ThreadLocalContextManager<C> threadLocalContextManager);

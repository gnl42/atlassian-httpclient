 ...
 */
public class AsyncHttpClientLibraryTest
{
    @Test
    public void testPluginStarts() throws IOException
    {
        ...
        HttpClient client = HttpClientBuilder.create()
                .build();
        URI pluginStateUri = baseUri.resolve("rest/plugins/1.0/com.atlassian.httpclient.atlassian-httpclient-library-plugin-key");
